...
/**
 * Utility functions for the FIDO authenticator.
 * Following the exact same pattern as Magic Link authenticator.
 */
public class FIDOAuthUtils {

    private static final Log log = LogFactory.getLog(FIDOAuthUtils.class);
    ...
    public static boolean isAccountLocked(AuthenticatedUser user) throws AuthenticationFailedException {
        ...
        try {
            ...
            String error = String.format(FIDOAuthenticatorConstants.ERROR_GETTING_ACCOUNT_LOCKED_STATE_MESSAGE,
                    FIDOAuthUtils.maskUsernameIfRequired(user.getUserName()));
