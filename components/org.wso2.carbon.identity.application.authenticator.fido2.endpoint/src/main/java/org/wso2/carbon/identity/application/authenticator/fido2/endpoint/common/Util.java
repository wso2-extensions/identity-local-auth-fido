...
public class Util {
    ...
    public static boolean isValidAuthenticationType() {
        ...
        FIDOAdminService.
         */
        if (IdentityUtil.threadLocalProperties.get().get(AUTHENTICATED_WITH_BASIC_AUTH) != null || Boolean
                .parseBoolean((String) IdentityUtil.threadLocalProperties.get().get(AUTHENTICATED_WITH_BASIC_AUTH))) {
